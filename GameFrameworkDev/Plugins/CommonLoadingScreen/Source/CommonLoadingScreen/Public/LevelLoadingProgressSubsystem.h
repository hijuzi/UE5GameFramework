...
#include "LevelLoadingProgressSubsystem.generated.h"
 ...
 * 与 ULoadingScreenManager 解耦——本子系统只负责进度计算，不管理 UI 显示。
 *
 * 使用方式：
 ...
 */
UCLASS(MinimalAPI)
class ULevelLoadingProgressSubsystem : public UGameInstanceSubsystem
{
	GENERATED_BODY()
